        ...
        <div className="px-6 py-10 xl:px-12">
          ...
          <div className="grid gap-10 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div className="md:col-span-2">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <p  href="mailto:contacto@tusitio.cl" className="inline-flex gap-2 items-center">
                  <Iconify icon="mdi:email-outline" className="w-5 h-5" />
                  contacto@medhogar.cl
                </p>
              </div>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-400">
                <li href="#recetas" className="hover:text-white">Recetas médicas</li>
                <li href="#ninos-adulto-mayor" className="hover:text-white">Niños y adulto mayor</li>
                <li href="#consulta-general" className="hover:text-white" >Consulta general</li>
                <li  href="#cronicas" className="hover:text-white">Enfermedades crónicas</li>
                <li  href="#prevencion" className="hover:text-white">Prevención y control</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-400">
                <li href="#sobre" className="hover:text-white">Sobre nosotros</li>
                <li href="#contacto" className="hover:text-white">Contacto</li>
                <li href="#faqs" className="hover:text-white">Preguntas frecuentes</li>
                <li href="#legal" className="hover:text-white">Términos y privacidad</li>
              </ul>
            </div>
          ...
          <div className="mt-10 border-t border-slate-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <p href="#" aria-label="Instagram" className="text-slate-400 hover:text-white">
                <Iconify icon="mdi:instagram" className="w-5 h-5" />
              </p>
              <p href="#" aria-label="Facebook" className="text-slate-400 hover:text-white">
