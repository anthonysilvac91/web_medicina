...
const Hero = () => {
  return (
    <section className='bg-bg-secondary padding-general flex flex-col-reverse md:flex-row justify-between items-center py-12 md:py-16 lg:py-20 '>
        <div className='md:w-[60%] 2xl:pr-22 xl:pr-20 lg:pr-26 md:pr-10'>
...
y confiable <span className='text-bg-primary'>donde estés</span></h1>
            <p className='text-text-primary lg:mt-5 lg:mb-7 md:mt-4 md:mb-5 mt-3 mb-4 p-responsive text-center sm:px-7 md:text-left md:px-0 lg:pr-8 xl:pr-0 '>Calidad en la comodidad de tu hogar. Consulta con especialistas cerca de ti.</p>
